		...
		function apply(ctx) {
			...
			slots.inject("shell.overlay", () => slots.register(
				...
				() => {
					...
					const onPointerUp = () => { setDrag(null); setResize(null); };
					...
					const panel = {
						...
						cursor: drag ? 'grabbing' : 'default', userSelect: 'none', touchAction: 'none',
					};
					const header = {
					...
					return React.createElement('div', { ref: nodeRef, style: panel, onPointerMove, onPointerUp },
						React.createElement('div', { style: header },
							React.createElement('span', { onPointerDown: onHeaderPointerDown, style: { flex: 1, cursor: 'grab', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } },
